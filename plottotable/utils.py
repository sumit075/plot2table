...
def mergeOutput(Images, out_path):
	...
	for i,image_name in enumerate(Images):
		input_str.append(pdf_output_dir + os.path.splitext(image_name)[0] + ".pdf")
...
def plotCSV(img_name):
	...
	data =  np.genfromtxt(csv_output_dir + base_name + ".csv", delimiter=',', skip_header=2, names=True, missing_values='-')
